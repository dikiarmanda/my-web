...
<head>
    ...
    <!-- icon pada title -->
    <link rel="icon" href="../assets/img/user-cog.svg">
</head>
...
<body>
    ...
    <div class="row mt-5 g-0">
        ...
        <div class="col-md-10 p-5 pt-5">
            <h3><i class="fas fa-user me-2"></i> DATA MEMBER</h3><hr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="ubah.php?idMember=<?= $row["idMember"] ?>" class="btn btn-success"><i class="fas fa-edit"></i></a>
                            <a href="hapus.php?idMember=<?= $row["idMember"] ?>" class="btn btn-danger ms-1" onclick="return confirm('Apakah Anda yakin menhapus member ini ?')">
